...
// NewValidateCustomRuleParams creates a new ValidateCustomRuleParams object
// with the default values initialized.
func NewValidateCustomRuleParams() *ValidateCustomRuleParams {
	var ()
	return &ValidateCustomRuleParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewValidateCustomRuleParamsWithTimeout creates a new ValidateCustomRuleParams object
...
// NewValidateCustomRuleParamsWithContext creates a new ValidateCustomRuleParams object
...
// NewValidateCustomRuleParamsWithHTTPClient creates a new ValidateCustomRuleParams object
...
/*ValidateCustomRuleParams contains all the parameters to send to the API endpoint
for the validate custom rule operation typically these are written to a http.Request
*/
